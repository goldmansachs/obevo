...
import com.gs.catodeployany.output.simple.AbstractMultiComparisonWriter;
import com.gs.catodeployany.util.IoUtil;
...
public class HTMLComparisonWriter extends AbstractMultiComparisonWriter {
     ...
     * (non-Javadoc)
     *
     * @see com.gs.catodeployany.output.CatoComparisonWriter#close()
     */
