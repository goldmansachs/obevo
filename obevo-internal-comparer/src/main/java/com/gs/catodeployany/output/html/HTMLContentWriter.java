 ...
 * under the License.
 */
package com.gs.catodeployany.output.html;
...
public class HTMLContentWriter implements CatoContentWriter {
    ...
    protected CatoContentMetadata contentMetadata;
     ...
     * (non-Javadoc)
     *
     * @see com.gs.catodeployany.output.CatoContentWriter#writeRow(com.gs.catodeployany.output.
     * CatoContentRow)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.gs.catodeployany.output.CatoContentWriter#openContent(com.gs.catodeployany.output.
     * CatoContentMetadata)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.gs.catodeployany.output.CatoContentWriter#closeContent()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.gs.catodeployany.output.CatoContentWriter#closeWriter()
     */
