...
import com.gs.catodeployany.input.aggregate.AggregateField;
...
public abstract class AbstractAggregateField<T, AT> implements AggregateField {
    ...
    protected AbstractAggregateField(String name, String baseField, boolean aggregateNulls, Class<T> clazz) {
        this.name = name;
