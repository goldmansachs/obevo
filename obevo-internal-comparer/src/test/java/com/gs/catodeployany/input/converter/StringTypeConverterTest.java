...
public class StringTypeConverterTest {
    ...
    private StringTypeConverter converter = new StringTypeConverter("MM/dd/yyyy HH:mm:ss", "MM/dd/yyyy");
    ...
    public void doubleConvertTest() {
        ...
        this.assertConvert(Double.class, 0.45565516, "0.45565516");
        this.assertConvert(Double.class, 0.4556551, ".4556551");
        this.assertConvert(Double.class, 3.0, "3.");
        this.assertConvert(Double.class, 3.0, "+3.0");
        this.assertConvert(Double.class, 3.0, "+3");
        this.assertConvert(Double.class, -3.0, "-3.0");
        this.assertConvert(Double.class, 123456789123456789123456789123456789123456789123456789.0, "123456789123456789123456789123456789123456789123456789");
    ...
    public void dateConvertTest() {
        ...
        this.assertConvert(Date.class, new GregorianCalendar(2010, Calendar.MAY, 12, 15, 5, 5).getTime(), "05/12/2010 15:05:05");
