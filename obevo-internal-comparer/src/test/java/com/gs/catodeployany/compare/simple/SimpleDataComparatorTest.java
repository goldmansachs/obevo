...
public class SimpleDataComparatorTest {
    ...
    public void testObjectCompare() {
        ...
        TestUtil.assertLogged(Level.DEBUG,
                "Comparing value abc of type com.gs.catodeployany.compare.simple.SimpleDataComparatorTest$1 " +
                        "to value def of different type com.gs.catodeployany.compare.simple.SimpleDataComparatorTest$2");

        TestUtil.clearLogged();

        org.junit.Assert.assertTrue(comparator.compareKeyValues(obj1, obj2) < 0);
        TestUtil.assertLogged(Level.DEBUG,
                "Comparing toString() methods for value abc of type com.gs.catodeployany.compare.simple.SimpleDataComparatorTest$1 " +
                        "to value def of different type com.gs.catodeployany.compare.simple.SimpleDataComparatorTest$2");
