...
DROP SYNONYM SYN_TABLE_A
GO

DROP SYNONYM SYN_VIEW1
GO
...
DROP PACKAGE BODY PKG_SP_WITH_OVERLOAD
GO
DROP PACKAGE PKG_SP_WITH_OVERLOAD
GO
DROP PACKAGE BODY PKG_FUNC_WITH_OVERLOAD
GO
DROP PACKAGE PKG_FUNC_WITH_OVERLOAD
GO

DROP TABLE MY_NESTED_TABLE
GO
DROP TYPE MY_NESTED_TABLE_TYPE
GO
DROP TYPE MyType2
GO
DROP TYPE MyType
