...
~
  ...
  CREATE UNIQUE INDEX "DBDEPLOY03"."SYS_C005395" ON "DBDEPLOY03"."TABLE_B_WITH_FK" ("B_ID")
...
~
  ...
  CREATE UNIQUE INDEX "DBDEPLOY03"."SYS_C005392" ON "DBDEPLOY03"."TABLE_B_WITH_MULTICOL_FK" ("B_ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS"
~
...
~
  ...
  CREATE UNIQUE INDEX "DBDEPLOY03"."SYS_C005390" ON "DBDEPLOY03"."TABLE_A_MULTICOL_PK" ("A1_ID", "A2_ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS"
~
...
~
  ...
  CREATE UNIQUE INDEX "DBDEPLOY03"."SYS_C005387" ON "DBDEPLOY03"."TABLE_A" ("A_ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS"
~
