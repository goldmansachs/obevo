...
~
  ...
  CREATE TABLE "DBDEPLOY01"."TABLE_A" 
   (	"A_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"EXTRA3" NUMBER(*,0), 
	"EXTRA4" NUMBER(*,0), 
	 CONSTRAINT "MYPK" PRIMARY KEY ("A_ID")
...
~
  ...
  CREATE TABLE "DBDEPLOY01"."TABLE_INDEX_TEST"
  ...
  USING INDEX (CREATE INDEX "DBDEPLOY01"."TABLE_INDEX_TEST_UNQ2_IND" ON "DBDEPLOY01"."TABLE_INDEX_TEST" ("ID2", "ID3")
...
~
  ...
  CREATE TABLE "DBDEPLOY01"."TABLE_SPECIAL_COL"
   (	"MYID" NUMBER(*,0) NOT NULL ENABLE,
	"LOB_FIELD" CLOB,
	"XML_FIELD" "XMLTYPE",
	"STRING_FIELD" VARCHAR2(30),
...
~
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DBDEPLOY01"."VIEW_SYMBOL#" ("A_ID", "STRING_FIELD") AS
