...
~
   ...
   COMMENT ON COLUMN "DBDEPLOY01"."COMMENT_COL_TABLE"."ID" IS 'comment1'
~

   COMMENT ON COLUMN "DBDEPLOY01"."COMMENT_COL_TABLE"."VAL2" IS 'comment2'
~
...
~
   ...
   COMMENT ON COLUMN "DBDEPLOY01"."COMMENT_VIEW"."A_ID" IS 'comment VIEW COL A_ID'
~
