  ...
  TABLESPACE "USERS"  ENABLE, 
	 FOREIGN KEY ("B_ID")
	  REFERENCES "MYSCHEMA01"."TABLE_B" ("B_ID") ENABLE
...
~
  ...
  CREATE UNIQUE INDEX "MYSCHEMA01"."SYS_C005609" ON "MYSCHEMA01"."TABLE_A" ("A_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 
~

  CREATE UNIQUE INDEX "MYSCHEMA01"."DEPL_EXEC_PK" ON "MYSCHEMA01"."ARTIFACTEXECUTION" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 
~

  CREATE UNIQUE INDEX "MYSCHEMA01"."ARTDEFPK" ON "MYSCHEMA01"."ARTIFACTDEPLOYMENT" ("ARTIFACTPATH", "OBJECTNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 
~

  CREATE UNIQUE INDEX "MYSCHEMA01"."SYS_C005606" ON "MYSCHEMA01"."TABLE_B" ("B_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 
~

  CREATE OR REPLACE EDITIONABLE SYNONYM "MYSCHEMA01"."SYN_TO_ADD" FOR "MYSCHEMA01"."TABLE_A"
~

   CREATE SEQUENCE  "MYSCHEMA01"."MYSEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION 
~

   CREATE SEQUENCE  "MYSCHEMA01"."MYSEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION 
~

  CREATE OR REPLACE EDITIONABLE SYNONYM "MYSCHEMA01"."SYN_TO_UPDATE" FOR "MYSCHEMA01"."TABLE_B"
~

  CREATE OR REPLACE EDITIONABLE SYNONYM "MYSCHEMA01"."SYN1" FOR "MYSCHEMA01"."TABLE_A"
~

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MYSCHEMA01"."VIEW1" ("A_ID", "B_ID", "STRING_FIELD", "TIMESTAMP_FIELD", "C_ID", "EXTRA1", "EXTRA2", "EXTRA3", "EXTRA4") AS 
  SELECT "A_ID","B_ID","STRING_FIELD","TIMESTAMP_FIELD","C_ID","EXTRA1","EXTRA2","EXTRA3","EXTRA4" FROM VIEW2
~

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MYSCHEMA01"."VIEW2" ("A_ID", "B_ID", "STRING_FIELD", "TIMESTAMP_FIELD", "C_ID", "EXTRA1", "EXTRA2", "EXTRA3", "EXTRA4") AS 
  SELECT "A_ID","B_ID","STRING_FIELD","TIMESTAMP_FIELD","C_ID","EXTRA1","EXTRA2","EXTRA3","EXTRA4" FROM TABLE_A WHERE A_ID = 4
~

  CREATE OR REPLACE EDITIONABLE FUNCTION "MYSCHEMA01"."SP3" (OUT mycount INT) RETURNS INT AS $$
BEGIN
...
~
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "MYSCHEMA01"."FUNC_WITH_OVERLOAD" (IN input INT, IN invalstr VARCHAR(32), OUT mycount INT) RETURNS INT AS $$
BEGIN
    SELECT count(*) into mycount FROM TABLE_A;
END;
$$ LANGUAGE plpgsql
...
~
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "MYSCHEMA01"."PKG_REMOVING_BODY" 
AS
...
~
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "MYSCHEMA01"."PKG_ADDING_BODY" 
AS
