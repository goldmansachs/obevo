...
public class MemSqlSqlExecutor extends AbstractSqlExecutor {
    private static final Logger LOG = LoggerFactory.getLogger(MemSqlSqlExecutor.class);

    public MemSqlSqlExecutor(DataSource ds) {
        super(ds);
    }
