...
import com.gs.obevo.db.impl.platforms.memsql.MemSqlDbPlatform;
import com.gs.obevo.db.impl.platforms.memsql.MemSqlParamReader;
...
public class MemSqlDbMetadataManagerIT extends AbstractDbMetadataManagerIT {
    @Parameterized.Parameters
    public static Iterable<Object[]> params() {
        return MemSqlParamReader.getParamReader().getJdbcDsAndSchemaParams();
    }

    public MemSqlDbMetadataManagerIT(DataSource dataSource, PhysicalSchema physicalSchema) {
        super(dataSource, physicalSchema);
    }

    @Override
    protected DbMetadataManager createMetadataManager() {
        return new MemSqlDbPlatform().getDbMetadataManager();
    }
    ...
    protected String getDropSqlFile() {
        return "memsql-test-drops.sql";
    }

    @Override
    protected String getAddSqlFile() {
        return "memsql-test.sql";
    }
