//// CHANGE name=init
CREATE TABLE ${dbdeploy01_subschemaSuffixed}DefaultColTest  (
...
GO
ALTER TABLE ${dbdeploy01_subschemaSuffixed}DefaultColTest ADD CONSTRAINT PK_DefaultColTest PRIMARY KEY (id)
GO
