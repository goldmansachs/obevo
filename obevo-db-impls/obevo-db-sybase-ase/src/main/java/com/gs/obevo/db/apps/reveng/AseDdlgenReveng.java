...
public class AseDdlgenReveng extends AbstractDdlReveng {
    ...
    private static ImmutableList<RevengPattern> getRevengPatterns() {
        ...
        return Lists.immutable.with(
                ...
                new AbstractDdlReveng.RevengPattern(ChangeType.SP_STR, namePatternType, "(?i)create\\s+proc(edure)?\\s+" + nameSubPattern, 2, null, null),
                ...
                new AbstractDdlReveng.RevengPattern(ChangeType.USERTYPE_STR, namePatternType, "(?i)^(exec\\s+)?sp_addtype\\s+'(\\w+)'", 2, null, null)
        );
    }
