...
public class AseToH2TranslationDialect extends DefaultDbTranslationDialect {
    @Override
    ...
    public void initSchema(JdbcHelper jdbc, Connection conn) {
        ...
        this.updateAndIgnoreException(conn, jdbc, "create domain UNIVARCHAR as VARCHAR");  // note - varchar is parameterized w/ the length. H2 can automatically have univarchar also parameterized
    }
