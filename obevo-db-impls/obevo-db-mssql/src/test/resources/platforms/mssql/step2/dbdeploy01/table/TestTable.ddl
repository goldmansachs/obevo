...
sp_rename '${dbdeploy01_subschemaSuffixed}TestTable.myNewCol2', 'myNewCol'
GO

//// CHANGE name=rename includeEnvs="unittest*"
ALTER TABLE ${dbdeploy01_subschemaSuffixed}TestTable ALTER COLUMN myNewCol2 RENAME TO myNewCol
GO
