...
public class MsSqlSameSchemaChangeAuditDaoTest extends SameSchemaChangeAuditDaoTest {
    @Parameterized.Parameters
    public static Collection<Object[]> params() {
        return MsSqlParamReader.getParamReader().getAppContextParams();
    }

    public MsSqlSameSchemaChangeAuditDaoTest(IntToObjectFunction<DbDeployerAppContext> getAppContext) {
        super(getAppContext);
    }
}
