...
public class ReladomoSchemaConverter {
    private static final Logger LOG = LoggerFactory.getLogger(ReladomoSchemaConverter.class);
    ...
    public void convertDdlsToDaFormat(final Platform platform, File inputDir, File outputDir, final String schemaName, boolean generateBaseline, String excludeObjects) {
        if (!inputDir.canRead()) {
        ...
        new RevengWriter().write(platform, changeEntries, outputDir, generateBaseline, RevengWriter.defaultShouldOverwritePredicate(), null, null, null, null, excludeObjects);
    }
