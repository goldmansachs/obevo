...
public class MithraSchemaConverterArgs {
    ...
    @Argument(value = "inputDir", required = true, description = "Input dir containing the Mithra DDLs")
    ...
    @Argument(value = "outputDir", required = true, description = "Output dir to write the Mithra DDLs")
    ...
    @Argument(value = "dbType", required = true, description = "DB Platform type where the Mithra DDLs were generated for. Pick from the values: [H2, HSQL, SYBASE_IQ, DB2, SYBASE_ASE, POSTGRESQL]")
