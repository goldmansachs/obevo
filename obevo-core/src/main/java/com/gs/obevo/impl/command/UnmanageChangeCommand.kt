...
class UnmanageChangeCommand(artifact: Change, private val reasonMessage: String) : AuditOnlyChangeCommand(artifact) {
    override fun markAuditTable(changeTypeBehaviorRegistry: ChangeTypeBehaviorRegistry, artifactDeployerDao: ChangeAuditDao, deployExecution: DeployExecution) {
        ...
        changeTypeBehaviorRegistry.unmanage(this.artifact, artifactDeployerDao)
    }

    companion object {
        private val LOG = LoggerFactory.getLogger(UnmanageChangeCommand::class.java)
    }
}
