...
public class UnmanageChangeCommand extends AuditOnlyChangeCommand {
    private static final Logger LOG = LoggerFactory.getLogger(UnmanageChangeCommand.class);
    private final String reasonMessage;

    public UnmanageChangeCommand(Change artifact, String reasonMessage) {
        super(artifact);
