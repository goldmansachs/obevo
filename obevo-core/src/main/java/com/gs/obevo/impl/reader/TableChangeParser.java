...
public class TableChangeParser extends AbstractDbChangeFileParser {
    ...
    @VisibleForTesting
    public TableChangeParser(DbChangeHashStrategy contentHashStrategy, GetChangeType getChangeType) {
        this(contentHashStrategy, false, new DeployMetricsCollectorImpl(), new TextMarkupDocumentReader(false), getChangeType);
    }

    public TableChangeParser(DbChangeHashStrategy contentHashStrategy, boolean backwardsCompatibleMode, DeployMetricsCollector deployMetricsCollector, TextMarkupDocumentReader textMarkupDocumentReader, GetChangeType getChangeType) {
    ...
    public interface GetChangeType {
        GetChangeType DEFAULT_IMPL = new GetChangeType() {
            @Override
        ...
        ChangeType getChangeType(TextMarkupDocumentSection section, ChangeType tableChangeType);
    }
    ...
    private ChangeIncremental create(ChangeType tableChangeType, TextMarkupDocumentSection section, String schema, String objectName,
            int changeIndex) {
