...
public class UnrolledbackChangeWarning implements ChangeCommandWarning {
    private final ChangeIncremental incrementalDeployed;

    public UnrolledbackChangeWarning(ChangeIncremental incrementalDeployed) {
        this.incrementalDeployed = incrementalDeployed;
    }

    @Override
    public String getCommandDescription() {
        return "No longer in the source, but will be left in the DB as we are running in rollback mode: " +
                this.incrementalDeployed.getDisplayString();
    }
