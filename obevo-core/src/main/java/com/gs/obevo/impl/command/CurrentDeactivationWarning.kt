...
class CurrentDeactivationWarning(private val incrementalDeployed: ChangeIncremental) : ChangeCommandWarning {
    override val commandDescription: String
        get() = "Currently deactivated change: " + this.incrementalDeployed.displayString
