...
/**
 * Interface to determine how the Charset is determined for the given input types.
 *
 * The common implementation either goes w/ a standard charset or derives it based on the bytes.
 *
