...
/**
 * Defines the common and non-platform-specific behaviors around deploying changes. Used in tandem with
 * {@link ChangeTypeBehavior}.
 */
public interface ChangeTypeSemantic {
    /**
