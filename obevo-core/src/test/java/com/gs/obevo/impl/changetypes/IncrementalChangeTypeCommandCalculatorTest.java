...
public class IncrementalChangeTypeCommandCalculatorTest {
    ...
    private final MutableSet<Integer> names = UnifiedSet.newSet();

    @Test
    public void testNewTableAdd() {
        Change tabA1Src = new ChangeIncremental(tableChangeType(), "schema", "tabA", this.changeName(), 0, "chng1", CONTENT);
    ...
    @Test
    public void testTableDrops() {
        Change tabC1Dep = new ChangeIncremental(tableChangeType(), "schema", "tabC", "chng1", 0, "tabCExistingToBeDropped", CONTENT);
        Change tabC1Src = new ChangeIncremental(tableChangeType(), "schema", "tabC", "chng1", 0, "tabCExistingToBeDropped", CONTENT);
        ...
        Change tabD1Src = new ChangeIncremental(tableChangeType(), "schema", "tabD", this.changeName(), 0, "tabDNewTableIsDropped", CONTENT);
        Change tabD2Src = new ChangeIncremental(tableChangeType(), "schema", "tabD", this.changeName(), 1,
    ...
    public void testIncrementalTableChange() {
        Change tabB0Dep = new ChangeIncremental(tableChangeType(), "schema", "tabB", this.changeName(), 0, "chng1", CONTENT);
        Change tabB0Src = new ChangeIncremental(tableChangeType(), "schema", "tabB", tabB0Dep.getChangeName(), 0, "chng1", CONTENT);
        Change tabB1FkSrc = new ChangeIncremental(foreignKeyChangeType(), "schema", "tabB", this.changeName(), 1, "chng1.5fk", CONTENT);
        Change tabB3Dep = new ChangeIncremental(tableChangeType(), "schema", "tabB", this.changeName(), 3, "chng3ToBeRolledback1", CONTENT);
        ...
        Change tabB4Src = new ChangeIncremental(tableChangeType(), "schema", "tabB", this.changeName(), 4, "chng4Insertion", CONTENT);
        Change tabB5Src = new ChangeIncremental(tableChangeType(), "schema", "tabB", this.changeName(), 5, "chng5AlreadyRolledBack", CONTENT, "rollback", true);
        Change tabB6Dep = new ChangeIncremental(tableChangeType(), "schema", "tabB", this.changeName(), 6, "chng6ToBeRolledback2", CONTENT);
