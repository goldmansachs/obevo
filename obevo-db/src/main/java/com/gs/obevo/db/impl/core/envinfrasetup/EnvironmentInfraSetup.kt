 ...
 */
interface EnvironmentInfraSetup<E : Environment<*>> {
    /**
     * Sets up the environment - should be an idempotent call. See [EnvironmentInfraSetup] javadoc for details.
     */
    fun setupEnvInfra(failOnSetupException: Boolean, forceCreation: Boolean)
}
