...
public class AquaRevengMain {
    ...
    private void doExecute(final AquaRevengArgs args) {
        ...
        new RevengWriter().write(args.getDbPlatform(), allRevEngDestinations, outputWriteFolder, this.generateBaseline, null, args.getDbHost(), args.getDbPort(), args.getDbServer());
    }
