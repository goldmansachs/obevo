...
public abstract class AbstractDbPlatform implements DbPlatform {
    ...
    protected AbstractDbPlatform(String name) {
        ...
        this.changeTypeMap = changeTypes.toMap(ChangeType.TO_NAME, Functions.<ChangeType>getPassThru()).toImmutable();
    }
     ...
     */
    public abstract Class<? extends DeployerAppContext> initializeAppContextBuilderClass();
     ...
     * Internal method meant to help subclasses modify the changeType list.
     */
    protected void replaceChangeType(MutableList<ChangeType> inputs, ChangeType changeType) {
        inputs.removeIf(Predicates.attributeEqual(ChangeType.TO_NAME, changeType.getName()));
